    ...
    <div class="container pos-vertical-center">
        <div class="row">
            <div class="col-sm-12 text-center">
                <h3><?php _lang('Search results for', 'templates/dream'); ?>: <span><?php print $keywords; ?></span></h3>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="">
            <?php if ($searchType == 'shop' OR $searchType == ''): ?>
                <span><em><?php _lang('Results found mentioning', 'templates/dream'); ?></em> &ldquo;<?php print $keywords; ?>&rdquo; <?php _lang("in Shop", "templates/dream"); ?></span>
                <div class="row">
            ...
            <?php if ($searchType == 'blog' OR $searchType == ''): ?>
                <span><em><?php _lang('Results found mentioning', 'templates/dream'); ?></em> &ldquo;<?php print $keywords; ?>&rdquo; <?php _lang("in Blog", "templates/dream"); ?></span>
                <br/>
                <br/>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <a class="btn btn--primary modal-trigger" href="#" data-modal-id="search-form">
                    <span class="btn__text"><?php _lang('New Search Query', 'templates/dream'); ?></span>
                </a>
            </div>
        </div>
    </div>
