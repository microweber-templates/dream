...
<section class="imagebg height-90 safe-mode mw-layout-overlay-wrapper <?php if ($is_parallax == 'yes'): ?>parallax<?php endif; ?> nodrop edit <?php print $padding ?>" field="layout-skin-26-<?php print $params['id'] ?>"
