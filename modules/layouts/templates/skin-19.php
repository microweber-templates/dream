...
name: Boxes with Icons and Text
...
<section class="stats-1 safe-mode bg--secondary nodrop edit <?php print $padding ?>" field="layout-skin-19-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row">
            <div class="col-sm-12 text-center allow-drop">
                <h4><?php _lang("Get to know us better&hellip;", "templates/dream"); ?></h4>
            </div>
        </div>
