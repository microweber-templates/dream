...
<section class="bg--dark safe-mode section--even edit nodrop <?php print $padding ?>" field="layout-skin-15-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row">
